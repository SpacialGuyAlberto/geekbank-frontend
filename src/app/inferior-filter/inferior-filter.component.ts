...
export class InferiorFilterComponent {
  ...
  platforms = [
    ...
    { name: 'META QUEST 1', icon: 'assets/meta.svg' },
    { name: 'META QUEST 2', icon: 'assets/meta.svg' },
    { name: 'META QUEST PRO', icon: 'assets/meta.svg' },
    { name: 'MOBILE', icon: 'assets/mobile.jpg' },
    { name: 'Nintendo 2DS', icon: 'assets/nintendo.-logo.jpg' },
    { name: 'Nintendo 3DS', icon: 'assets/nintendo.-logo.jpg' },
    { name: 'Nintendo Switch', icon: 'assets/Nintendo_Switch_logo,_square.png' },
    { name: 'Official Website', icon: 'assets/desktop-solid.svg' },
